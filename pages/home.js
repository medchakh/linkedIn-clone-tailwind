  ...
  return (
    <div className="space-y-10 relative">
      ...
      <main className="flex flex-col xl:flex-row items-center max-w-screen-lg mx-auto">
        ...
        <div className="relative xl:absolute w-80 h-80 xl:w-[650px] xl-h-[650px] top- right-5 ">
          <Image
            src="https://olc.org/wp-content/uploads/2021/07/LinkedIn-Learning-Graphic-for-Libraries.png"
            layout="fill"
            objectFit="contain"
            priority
          />
